export function joinChannel(message, text) {
...
export function leaveChannel(message, text) {
  text.forEach( channelName => {
...
export function doRoles(message) {
...
export function prune(channel, numberOfMessages) {
